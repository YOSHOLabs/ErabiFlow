# TateClipへのコントリビューション

TateClipは、AIに完成動画を任せるのではなく、人が見どころと不要部分を判断し、既存の動画編集ソフトへ正確に渡すことを優先します。
...
TateClip本体はOSSではありません。Pull Requestを提出する人は、その変更を提出する権利があることを表明し、採用された変更についてYOSHOLabsへ、使用、複製、変更、配布、サブライセンスおよび別条件での提供に必要な、永続的、世界的、非独占的、無償、取消不能な権利を許諾するものとします。
